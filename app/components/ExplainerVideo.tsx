...
export default function ExplainerVideo() {
  return (
    <section className="py-24 bg-industrial-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-orbitron font-black leading-tight">
            How Our <br /> <span className="text-industrial-accent">Systems Integrate.</span>
          </h2>
          <p className="text-industrial-chrome text-lg leading-relaxed font-medium">
            WEKA machineries utilize specialized kinetic loops and real-time telemetry 
          ...
          <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/5">
             <div>
               <div className="text-3xl font-orbitron font-black text-white">0.4ms</div>
               <div className="text-[10px] font-bold uppercase tracking-widest text-industrial-steel">Data Latency</div>
             </div>
             <div>
               <div className="text-3xl font-orbitron font-black text-white">100%</div>
               <div className="text-[10px] font-bold uppercase tracking-widest text-industrial-steel">Sync Accuracy</div>
             </div>
          </div>
        </motion.div>
        ...
        >
           ...
           <div className="absolute inset-12 border border-industrial-accent/20 rounded-full animate-[spin_15s_linear_infinite_reverse]" />
